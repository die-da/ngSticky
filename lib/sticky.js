    ...
    module.directive('sticky', ['$window', '$timeout', function($window, $timeout) {
            return {
                ...
                scope: {
                    ...
                    stickFunction: '&stickyOnStick',
                    unstickFunction: '&stickyOnUnstuck'
                },
                link: function linkFn($scope, $elem, $attrs) {
                    ...
                    function unStickElement(fromDirection) {
                        ...
                        var shouldCallUnstickFunction = isSticking;
                        ...
                        if (placeholder && (fromDirection === 'top' || fromDirection === 'bottom')) {
                            placeholder.remove();
                        }

                        if (shouldCallUnstickFunction) {
                            $scope.unstickFunction();
                        }
                    }
